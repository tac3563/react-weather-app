/* 
    ...
    3. Create isSearching state - local state in Search component which is updated by SearchBar and shared back down to Search child components (SearchBar, SearchLocations, SearchResults)
